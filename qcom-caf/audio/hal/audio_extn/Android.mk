...
LOCAL_C_INCLUDES := \
    ...
    device/10or/E/qcom-caf/audio/hal \
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    device/10or/E/qcom-caf/audio/hal \
    device/10or/E/qcom-caf/audio/hal/$(AUDIO_PLATFORM) \
    $(call include-path-for, audio-effects)
...
PRIMARY_HAL_PATH := device/10or/E/qcom-caf/audio/hal
AUDIO_PLATFORM := $(TARGET_BOARD_PLATFORM)
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    device/10or/E/qcom-caf/audio/hal \
    device/10or/E/qcom-caf/audio/hal/audio_extn \
    device/10or/E/qcom-caf/audio/hal/$(AUDIO_PLATFORM) \
